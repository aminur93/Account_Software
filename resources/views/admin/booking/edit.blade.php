...
<div class="panel panel-inverse text-dark">
    ...
    <div class="panel-body">
        <div class="row">
            <form action="{{ route('booking.update') }}" method="post" id="booking">
                @csrf
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="booking_no" class="form-control" id="booking_no" value="{{ $booking->booking_no }}" required>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="booking_type" id="booking_type" class="form-control" required>
                            ...
                            @foreach ($types as $type)
                                <option value="{{ $type }}" @if($booking->booking_type == $type)selected @endif>{{ $type }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="seller_name" class="form-control swidth" name="seller_name" required>
                            ...
                            @foreach ($sellers as $seller)
                                <option value="{{ $seller->id }}" @if($booking->sellerId == $seller->id)selected @endif>{{ $seller->seller_name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select id="customer_name" class="form-control swidth" name="customer_name" required>
                            ...
                            @foreach ($customers as $customer)
                                <option value="{{ $customer->id }}" @if($booking->customerid == $customer->id)selected @endif>{{ $customer->customer_name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="branch_name" class="form-control swidth" name="branch_name" required>
                            ...
                            @foreach ($branches as $branch)
                                <option value="{{ $branch->id }}" @if($booking->branchId == $branch->id)selected @endif>{{ $branch->branch_name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="company_name" class="form-control swidth" name="company_name">
                            @foreach($company as $com)
                                <option @if($booking->companyId == $com->id) selected @endif value="{{ $com->id }}">{{ $com->company_name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <select id="category_name" class="form-control swidth" name="category_name" required>
                            ...
                            {?>
                            <option value="{{ $dc->id }}" @if($booking->categoryId == $dc->id)selected @endif>{{ $dc->name }}</option>
                    ...
                    <div class="form-group">
                        ...
                        <select id="sub_category_name" class="form-control swidth" name="sub_category_name" required>
                            ...
                            @foreach($sub_categories as $sc)
                                <option value="{{ $sc->id }}" @if($booking->subcategoryId == $sc->id)selected @endif>{{ $sc->sname }}</option>
                                @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <span class="text-danger">*</span>
                        <input type="number" name="sqft" class="form-control" id="sqft" value="{{ $booking->sqfit }}" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <span class="text-danger">*</span>
                        <input type="text" value="{{ $booking->booking_date }}" class="form-control" id="datepicker" name="booking_date" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <span class="text-danger">*</span>
                        <input type="number" name="total_price" class="form-control" id="total_price" value="{{ $booking->total_price }}" required>
                    </div>
                </div>
                <div class="col-md-12">
