    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                <h4 class="panel-title">Vendor Payment Create</h4>
            </div>
            <div class="panel-body">
                <form action="{{ route('vendorStore.store') }}" method="post" id="vendor_payment" enctype="multipart/form-data">@csrf
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <div class="form-group pull-right">
                                    <a href="{{url('/expenses/vendor')}}" class="btn btn-info">Back</a>
            ...
            $(document).ready(function () {
                $('#vendor_payment').validate({
                    ...
                    messages: {
                        ...
                        amount: {
                            required: "<span class='text-danger'>This Amount field is Required</span>"
                        },
                        vendor: {
                            required: "<span class='text-danger'>This Vendor field is Required</span>"
                        },
                        branch: {
                            required: "<span class='text-danger'>This Branch field is Required</span>"
                        },
                        payment_method: {
                            required: "<span class='text-danger'>This Payment Method field is Required</span>"
                        },
                        account: {
