                ...
                <div class="form-group col-md-2">
                    <select class="form-control" name="source_name">
                        ...
                        @foreach($sources as $source)
                            <option {{  request()->has('source_name') != '' ? ( request()->source_name == $source->source_name ? 'selected' : "") : '' }} value="{{ $source->source_name }}">{{ $source->source_name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group col-md-2">
