...
@section('page')
    Sales Commission Expense Summary
@endsection
                ...
                <div class="form-group col-md-2">
                    <select class="form-control" name="seller_id">
                        ...
                        @foreach($sellers as $sales)
                            <option {{  request()->has('seller_id') != '' ? ( request()->seller_id == $sales->id ? 'selected' : "") : '' }} value="{{ $sales->id }}">{{ $sales->seller_name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group col-md-2">
